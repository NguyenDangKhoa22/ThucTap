...
const HeaderToDo = ({tasksCount}:HeaderToDoProps) =>{
    return(
        <>
        <header>
          <div className="mx-auto px-14 p-14">
            <div className='mx-auto w-2/4 border-b '>
                <div className='flex'>
